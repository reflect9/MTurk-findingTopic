...
# 	ax.set_ylim(0,220)
# 	ax.set_ylabel(str(wordNum) + " words")
# 	xTickMarks = ["Word List","Word List w/ Bars","Word Cloud","Network Graph","Algorithm"]	
#  	ax.set_xticks(ind+width)
# 	xtickNames = ax.set_xticklabels(xTickMarks)
# 	plt.setp(xtickNames)
...
# fig.text(0.03, 0.5, '# of votes', fontsize=15, ha='center', va='center', rotation='vertical')
# fig.suptitle('Label Evaluation (Short)', fontsize=19)
# # ax.legend( (rects1[0], rects2[0], rects3[0], rects4[0]), modes, loc=1)


# fig.set_size_inches(10, 8)
# fig.savefig('images/short-votes-new.pdf')
# # plt.show()
# exit()	
...
# 	ax.set_ylim(0,220)
# 	ax.set_ylabel(str(wordNum) + " words")
# 	xTickMarks = ["Word List","Word List w/ Bars","Word Cloud","Network Graph"]	
# 	ax.set_xticks(ind+width)
# 	xtickNames = ax.set_xticklabels(xTickMarks)
# 	plt.setp(xtickNames)
...
# fig.savefig('images/long-votes-new.pdf')
...
### PEARSON CORR
print stats.pearsonr(topic_duration_list, topic_coherence)
print stats.linregress(topic_duration_list, topic_coherence)
# plt.show()
...
print stats.pearsonr(confidence_list, topic_coherence)
(slope, intercept, r,p,stderr) = stats.linregress(confidence_list, topic_coherence)
print "r-squared: ", r**2
r_square = "{:.2f}".format(r**2)
x_list = [min(confidence_list),max(confidence_list)]
y_list = [slope*x + intercept for x in x_list]

plt.plot(x_list, y_list, '-b', linewidth=2)
ax.text(2.8,0.07, "Slope = "+"{:.2f}".format(slope)+"\n"+r'$R^2=$'+r_square, fontsize=21, color='b') 
fig.set_size_inches(18, 8)
fig.savefig('images/coh_time_conf_pearson.pdf')
